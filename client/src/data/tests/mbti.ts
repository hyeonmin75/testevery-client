...
export const mbtiTest: TestData = {
  ...
  results: {
    ...
    'ESTP': {
      ...
      personalityStory: '당신은 마치 스릴 넘치는 액션 영화의 주인공처럼 현재 순간에 완전히 몰입하며 살아가는 진정한 행동파입니다. 복잡한 이론이나 장황한 계획보다는 직접 몸으로 부딪치며 경험하는 것을 선호하며, 예상치 못한 위기 상황에서도 놀라운 침착함과 순발력으로 최적의 해결책을 찾아냅니다. 타고난 사교성과 친근한 매력으로 어떤 사람과도 금세 친해지며, 새로운 환경에 던져져도 물고기가 물을 만난 듯 자연스럽게 적응해나갑니다. 때로는 먼 미래보다 눈앞의 현실에 집중하는 경향이 있지만, 그것은 추상적인 가능성보다는 확실하고 구체적인 결과를 만들어내려는 당신의 실용주의 철학에서 나오는 것입니다.',
    ...
    'INTJ': {
      ...
      personalityStory: '당신은 마치 거대한 성당을 설계하는 건축가처럼 먼 미래를 내다보며 웅장한 계획을 세우는 진정한 비전가입니다. 복잡하고 어려운 시스템도 한눈에 파악하여 핵심을 찾아내고, 혁신적인 개선방안을 제시하는 탁월한 전략적 사고력을 가지고 있습니다. 혼자만의 고요한 시간 속에서 깊이 있는 성찰과 분석을 통해 완벽에 가까운 계획을 수립하며, 한번 목표를 정하면 흔들림 없는 의지력으로 끝까지 추진해나갑니다. 표면적인 인간관계보다는 진정으로 가치 있는 소수의 관계를 선호하며, 자신만의 엄격한 기준에 따라 모든 것을 완벽하게 만들어내려 노력합니다. 때로는 감정적 소통보다 논리적 효율성을 우선시하는 경향이 있지만, 그것은 최고의 결과를 통해 더 큰 가치를 창조하려는 당신의 숭고한 의지에서 비롯됩니다.',
    ...
    'INTP': {
      ...
      personalityStory: '당신은 마치 끝없는 미지의 영역을 탐험하는 호기심 많은 과학자처럼, 세상의 모든 현상과 아이디어에 대해 깊이 파고드는 진정한 지식 탐구자입니다. 복잡하고 추상적인 개념들을 논리적으로 분해하여 핵심 원리를 찾아내는 능력이 탁월하며, 기존의 틀에 얽매이지 않고 완전히 새로운 관점에서 문제를 바라보는 독창적 사고력을 가지고 있습니다. 혼자만의 시간을 통해 자유롭게 사고의 나래를 펼치며, 남들이 당연하게 여기는 것들에 대해서도 "왜?"라는 질문을 던지는 철학자적 기질을 보입니다. 완벽한 이론적 체계를 구축하는 것에 매료되어 있으며, 진리를 향한 순수한 열정으로 끊임없이 학습하고 성장해나갑니다. 때로는 실제 적용보다는 이론적 완성도에 더 몰입하는 경향이 있지만, 그것은 근본적이고 완벽한 해답을 찾으려는 당신의 학자적 양심에서 비롯됩니다.',
    ...
    'INFP': {
      ...
      personalityStory: '당신은 마치 시인의 영혼을 가진 몽상가처럼, 마음 깊은 곳에 아름답고 순수한 이상향을 품고 살아가는 진정한 예술가입니다. 세상의 모든 아름다운 것들을 섬세하게 느끼고 표현하는 능력이 뛰어나며, 진정성과 의미를 추구하는 삶을 살고자 노력합니다. 타인의 감정과 고통에 깊이 공감하며 치유의 손길을 내미는 따뜻한 마음의 소유자이자, 자신만의 독특한 가치관과 철학을 가지고 흔들림 없이 살아가는 의지를 보입니다. 완벽한 조화와 평화를 꿈꾸며 갈등과 대립을 피하려 하지만, 그것은 모든 존재가 행복하고 자유로울 수 있는 세상을 만들고 싶은 순수한 열망에서 비롯됩니다. 때로는 현실의 벽에 부딪혀 좌절하기도 하지만, 그럴 때마다 내면의 창의적 에너지를 통해 새로운 희망과 영감을 찾아내는 놀라운 회복력을 보여줍니다.',
    ...
    'ISTJ': {
      ...
      personalityStory: '당신은 마치 견고한 성채의 수호자처럼 세상의 질서와 안정을 지키는 든든한 기둥 같은 존재입니다. 어떤 어려운 상황에서도 흔들리지 않는 의지력과 책임감으로 맡은 바 임무를 완벽하게 수행하며, 전통적 가치와 검증된 방법을 신뢰하여 안전하고 예측 가능한 환경을 만들어냅니다. 체계적이고 논리적인 접근 방식으로 복잡한 업무도 단계별로 차근차근 해결해나가며, 꼼꼼한 관찰력과 정확한 판단력으로 실수를 최소화합니다. 신뢰할 수 있는 인격과 일관성 있는 행동으로 주변 사람들에게 안정감을 제공하며, 한번 약속한 것은 반드시 지키는 의리와 성실함을 보여줍니다. 때로는 급작스러운 변화나 새로운 방식에 대해 신중한 태도를 보일 수 있지만, 그것은 검증되지 않은 실험보다는 확실하고 안전한 방법을 통해 최선의 결과를 얻으려는 현명한 판단력에서 비롯됩니다.',
