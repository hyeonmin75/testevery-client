...
export const mbtiTest: TestData = {
  ...
  results: {
    'ENTJ': {
      ...
      personalityStory: '당신은 마치 체스판 위의 그랜드마스터처럼 세상을 바라보는 타고난 전략가입니다. 복잡하게 얽힌 상황 속에서도 가장 효율적인 해결책을 찾아내는 능력이 탁월하며, 마치 미래를 내다보는 듯한 통찰력으로 팀을 올바른 방향으로 이끌어갑니다. 당신이 회의실에 들어서면 자연스럽게 모든 시선이 집중되고, 복잡한 프로젝트도 당신의 손에서 체계적으로 정리됩니다. 목표를 향한 추진력이 강하여 장애물을 만나도 새로운 돌파구를 찾아내며, 팀원들의 잠재력을 파악하여 각자에게 가장 적합한 역할을 부여하는 탁월한 인재 관리 능력을 보입니다. 때로는 완벽주의적 성향 때문에 스스로에게도, 타인에게도 높은 기준을 요구하지만, 그것은 모든 일을 최고의 결과로 만들어내고 싶은 순수한 열정에서 비롯됩니다.',
    ...
    'ENTP': {
      ...
      personalityStory: '당신은 마치 끝없는 호기심을 가진 탐험가처럼, 세상의 모든 가능성을 발견하고 탐구하려는 열정으로 가득한 사람입니다. 기존의 틀과 관습에 얽매이지 않고 창의적인 해결책을 찾아내는 능력이 뛰어나며, 마치 천재적인 발명가처럼 아무도 생각하지 못한 새로운 아이디어를 끊임없이 생산해냅니다. 사람들과의 토론에서 진정한 에너지를 얻으며, 서로 다른 관점을 듣고 배우는 과정에서 더욱 풍부한 아이디어를 발전시킵니다. 때로는 여러 가지 일을 동시에 진행하느라 집중력이 분산되기도 하지만, 그것은 세상의 무한한 가능성을 놓치고 싶지 않은 당신의 순수한 열정에서 비롯됩니다. 변화를 두려워하지 않고 항상 새로운 도전을 즐기며, 주변 사람들에게도 새로운 시각과 영감을 제공하는 촉매제 역할을 합니다.',
    ...
    'ENFJ': {
      ...
      personalityStory: '당신은 마치 따뜻한 태양처럼 주변 사람들에게 에너지와 희망을 선사하는 천부적인 리더입니다. 타인의 성장과 발전을 돕는 것에서 진정한 보람을 느끼며, 마치 숙련된 가드너가 각각의 식물에게 맞는 관심과 돌봄을 제공하듯 개개인의 특성을 파악하여 최적의 지도와 격려를 제공합니다. 당신의 진심어린 관심과 공감능력은 사람들로 하여금 자신도 몰랐던 잠재력을 발견하게 만들며, 자연스럽게 팀의 중심이 되어 모든 구성원들이 조화롭게 협력할 수 있는 환경을 만들어냅니다. 때로는 다른 사람들의 필요를 우선시하느라 자신의 건강과 행복을 소홀히 하기도 하지만, 그것은 세상을 더 나은 곳으로 만들고자 하는 당신의 숭고한 사명감에서 비롯되는 것입니다.',
    ...
    'INFJ': {
      ...
      personalityStory: '당신은 마치 숨겨진 보석을 찾아내는 탐험가처럼, 사람들 내면에 숨어있는 가능성과 잠재력을 발견하는 특별한 능력을 가지고 있습니다. 세상을 더 나은 곳으로 만들고자 하는 깊은 사명감을 품고 있으며, 단순히 현재에 만족하지 않고 항상 더 의미있고 가치있는 미래를 그려냅니다. 당신의 직감은 마치 레이더처럼 예민하여 다른 사람들이 놓치는 미묘한 감정의 변화나 숨겨진 메시지까지도 정확히 포착해냅니다. 혼자만의 고요한 시간을 통해 복잡한 세상 속에서 자신만의 철학과 가치관을 정립해나가며, 한번 확신을 가진 일에는 흔들림 없는 신념으로 끝까지 밀고 나갑니다. 때로는 자신과 타인에게 너무 높은 기준을 요구하여 스스로를 괴롭히기도 하지만, 그것은 모든 일에 깊은 의미와 목적을 부여하려는 당신의 순수하고 고귀한 마음에서 비롯됩니다.',
