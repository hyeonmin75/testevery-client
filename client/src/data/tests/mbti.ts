...
export const mbtiTest: TestData = {
  ...
  results: {
    'ENTJ': {
      ...
      personalityStory: '당신은 마치 체스판 위의 그랜드마스터처럼\n세상을 바라보는 타고난 전략가입니다.\n\n복잡하게 얽힌 상황 속에서도\n가장 효율적인 해결책을 찾아내는 능력이 탁월하며,\n마치 미래를 내다보는 듯한 통찰력으로\n팀을 올바른 방향으로 이끌어갑니다.\n\n당신이 회의실에 들어서면\n자연스럽게 모든 시선이 집중되고,\n복잡한 프로젝트도 당신의 손에서\n체계적으로 정리됩니다.\n\n목표를 향한 추진력이 강하여\n장애물을 만나도 새로운 돌파구를 찾아내며,\n팀원들의 잠재력을 파악하여\n각자에게 가장 적합한 역할을 부여하는\n탁월한 인재 관리 능력을 보입니다.',
      bestMatch: 'INFP 유형과는 서로 완전히 다른 강점을 가진\n완벽한 보완 관계입니다!\n\n당신의 강력한 추진력과 체계적 사고가\n그들의 창의성과 유연함과 만나면,\n서로를 성장시키는 환상적인 시너지를 만들어냅니다.\n\n당신이 큰 그림을 그릴 때\n그들은 세밀한 감성을 더해주고,\n그들이 방향을 잃을 때\n당신은 명확한 길을 제시해줍니다.',
      loveStyle: '당신의 사랑은 마치 든든한 등대처럼\n상대방에게 방향과 안정감을 제공합니다.\n\n연인과 함께 구체적인 미래 계획을 세우고\n그것을 실현해가는 과정에서 깊은 만족감을 느끼며,\n서로의 성장과 발전을 위해 아낌없이 투자하는\n진정한 파트너십을 추구합니다.\n\n때로는 너무 체계적으로 접근하려 하지만,\n그것은 상대방과의 관계를 더욱 견고하고\n의미있게 만들려는 진심어린 마음 때문입니다.',
      celebrities: ['스티브 잡스', '빌 게이츠', '나폴레옹'],
      careers: ['CEO', '경영컨설턴트', '변호사', '정치인', '군인'],
      animalMetaphor: '당신은 무리를 이끄는 알파 늑대 같은 존재입니다.\n\n강력한 카리스마와 본능적인 리더십으로\n팀을 통솔하며,\n위험한 상황에서도 침착하게 방향을 제시합니다.\n\n늑대처럼 충성스러운 동료들과 함께할 때\n진정한 힘을 발휘하며,\n목표를 향해 흔들림 없이 전진하는\n불굴의 의지를 가지고 있습니다.',
      percentage: 3,
      rarity: '상위 3% 희귀 유형'
    },
    'ENTP': {
      ...
      personalityStory: '당신은 마치 끝없는 호기심을 가진 탐험가처럼,\n세상의 모든 가능성을 발견하고 탐구하려는\n열정으로 가득한 사람입니다.\n\n기존의 틀과 관습에 얽매이지 않고\n창의적인 해결책을 찾아내는 능력이 뛰어나며,\n마치 천재적인 발명가처럼\n아무도 생각하지 못한 새로운 아이디어를\n끊임없이 생산해냅니다.\n\n사람들과의 토론에서 진정한 에너지를 얻으며,\n서로 다른 관점을 듣고 배우는 과정에서\n더욱 풍부한 아이디어를 발전시킵니다.\n\n변화를 두려워하지 않고\n항상 새로운 도전을 즐기며,\n주변 사람들에게도 새로운 시각과 영감을\n제공하는 촉매제 역할을 합니다.',
      bestMatch: 'INFJ 유형과는 정말 환상적인 조합입니다!\n\n당신의 무한한 창의성과\n그들의 깊은 통찰력이 만나면\n서로를 완벽하게 보완하는 관계가 됩니다.\n\n당신이 새로운 아이디어를 쏟아낼 때\n그들은 그 중에서 진정 가치있는 것들을 선별해주고,\n그들이 너무 신중할 때\n당신은 과감한 도전으로 새로운 길을 열어줍니다.',
      loveStyle: '당신의 사랑은 마치 무지개처럼\n다채롭고 역동적입니다.\n\n연인과 함께 새로운 경험을 탐험하고\n지적인 자극을 주고받는 관계를 선호하며,\n서로의 꿈과 아이디어를 격려하고\n발전시켜나가는 창의적 파트너십을 추구합니다.\n\n일상의 루틴보다는 예상치 못한 모험과\n깊이있는 대화를 통해\n관계를 더욱 깊게 만들어갑니다.',
      celebrities: ['로버트 다우니 주니어', '톰 행크스', '라이언 레이놀즈'],
      careers: ['마케터', '광고기획자', '창업가', '저널리스트', '컨설턴트'],
      animalMetaphor: '당신은 호기심 많고 지능적인\n돌고래 같은 존재입니다.\n\n돌고래처럼 사회적이고 놀이를 좋아하며,\n새로운 환경에 빠르게 적응하는 능력이 뛰어납니다.\n\n다른 돌고래들과의 소통을 즐기고,\n창의적인 방법으로 문제를 해결하며,\n자유롭게 바다를 누비듯\n무한한 가능성의 세계를 탐험합니다.',
      percentage: 3,
      rarity: '상위 3% 희귀 유형'
    },
    'ENFJ': {
