...
export const mbtiTest: TestData = {
  ...
  results: {
    ...
    'ESFJ': {
      ...
      personalityStory: '당신은 마치 따뜻한 햇살처럼 주변 사람들에게 위안과 안정감을 제공하는 천생 케어테이커입니다.\n\n타인의 감정과 필요를 민감하게 포착하는 레이더 같은 능력을 가지고 있으며, 누군가가 도움이 필요할 때 가장 먼저 달려가는 든든한 지원군 역할을 자처합니다.\n\n조화롭고 평화로운 환경을 만들기 위해 끊임없이 노력하며, 전통적인 가치와 예의를 소중히 여기는 올바른 인성의 소유자입니다.\n\n사회적 규범과 기대에 부응하려 노력하며, 모든 사람이 편안하고 행복할 수 있는 분위기를 조성하는 데 탁월한 재능을 보입니다.',
