...
export const mbtiTest: TestData = {
  ...
  results: {
    ...
    'ESTJ': {
      ...
      personalityStory: '당신은 마치 든든한 기둥처럼 조직과 사회를 떠받치는 천생 리더입니다.\n\n체계적이고 논리적인 접근 방식으로 복잡한 문제들을 해결해나가며, 강력한 실행력과 완벽한 조직력으로 어떤 프로젝트든 성공으로 이끌어냅니다.\n\n전통적 가치와 검증된 방법을 신뢰하여 안정적이고 예측 가능한 환경을 만들어가며, 팀원들에게는 명확한 방향성과 확실한 지원을 제공합니다.\n\n때로는 새로운 변화에 대해 신중한 태도를 보일 수 있지만, 그것은 무분별한 실험보다는 검증된 성공 방법을 통해 더 큰 안전성을 확보하려는 현명한 판단에서 비롯됩니다.',
    ...
    'ESFP': {
      ...
      personalityStory: '당신은 마치 화려한 무지개처럼 삶에 색채와 활력을 불어넣는 진정한 엔터테이너입니다.\n\n어디를 가든 자연스럽게 분위기를 밝게 만들고, 사람들의 얼굴에 미소를 짓게 하는 마법 같은 능력을 가지고 있습니다.\n\n현재 순간에 완전히 몰입하며 삶의 작은 기쁨들을 놓치지 않고 만끽하는 특별한 재능이 있으며, 즉흥적이고 자발적인 행동으로 예상치 못한 즐거움을 만들어냅니다.\n\n진정성 있는 감정 표현과 따뜻한 공감능력으로 사람들과 깊은 유대감을 형성하며, 누구와도 편안하고 자연스러운 관계를 맺을 수 있는 사교적 천재입니다.',
    ...
    'ISTP': {
      ...
      personalityStory: '당신은 마치 숙련된 장인처럼 손끝에서 마법을 부리는 실용적 천재입니다.\n\n복잡한 이론이나 추상적 개념보다는 직접 만지고 체험하며 배우는 것을 선호하며, 기계나 도구를 다루는 탁월한 손재주와 직관적 이해력을 가지고 있습니다.\n\n어떤 예상치 못한 위기 상황에서도 침착함을 유지하며 현실적이고 즉각적인 해결책을 찾아내는 능력이 뛰어나고, 독립적이고 자유로운 환경에서 자신만의 속도로 완벽한 결과물을 만들어냅니다.\n\n다른 사람들의 간섭이나 지나친 관심보다는 혼자만의 시간과 공간에서 집중할 때 최고의 퍼포먼스를 발휘하며, 말보다는 행동으로 자신의 능력을 증명하는 것을 선호합니다.',
    ...
    'ISFJ': {
      ...
      personalityStory: '당신은 마치 따뜻한 어머니의 품처럼 주변 사람들에게 무조건적인 사랑과 보호를 제공하는 진정한 수호천사입니다.\n\n다른 사람들의 감정과 필요를 레이더처럼 민감하게 포착하며, 누군가 힘들어할 때 가장 먼저 달려가 위로와 실질적인 도움을 제공하는 따뜻한 마음의 소유자입니다.\n\n전통적인 가치와 예의를 소중히 여기며 안정적이고 조화로운 환경을 만들기 위해 자신을 희생해서라도 헌신하는 이타적인 성품을 가지고 있습니다.\n\n갈등과 불화를 싫어하여 평화로운 분위기 조성을 위해 끊임없이 노력하며, 신뢰할 수 있는 조언자이자 든든한 버팀목 역할을 자처합니다.',
    ...
    'ISFP': {
      ...
      personalityStory: '당신은 마치 자연 속에서 자유롭게 춤추는 나비처럼 순수하고 아름다운 영혼을 가진 진정한 예술가입니다.\n\n세상의 모든 아름다운 것들에 대해 섬세한 감수성을 가지고 있으며, 자신만의 독특하고 창의적인 시각으로 평범한 일상도 특별한 예술 작품으로 바라보는 능력이 있습니다.\n\n다른 사람들을 있는 그대로 받아들이고 판단하지 않는 포용력을 가지고 있으며, 갈등과 대립보다는 평화롭고 조화로운 환경에서 진정한 행복을 느끼는 평화주의자입니다.\n\n자신의 가치관과 신념에 따라 진정성 있게 살아가려 노력하며, 타인에게 상처를 주는 것을 극도로 싫어하는 따뜻하고 순수한 마음의 소유자입니다.',
